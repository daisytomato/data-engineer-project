...
BUCKET_NAME = "my_ny_trip_data_2019"
...
def download_file(month):
    file_paths = []
    for color in colors:
        url = f"{BASE_URL}/{color}_tripdata_2019-{month}.parquet"
        file_path = os.path.join(DOWNLOAD_DIR, f"{color}_tripdata_2019-{month}.parquet")
...
if __name__ == "__main__":
    ...
    file_paths = [fp for sublist in results if sublist for fp in sublist]
